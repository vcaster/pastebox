...
<div class="container">
 ...
 <?php
          if(isset($_POST['login'])) {
             ...
             $username = isset($_POST['username']) ? mysqli_real_escape_string($_POST['username']) : "empty";
             $password =  isset($_POST['password']) ? mysqli_real_escape_string($_POST['password']) : "empty";
